...
from resource_params_tree import generate_resource_parameter_tree
from utils import read_yaml


def generate_parameter_tree(api_path, cloud_name, tags, output):
...
if __name__ == "__main__":
    ...
    try:
        generate_parameter_tree(*sys.argv[1:])
